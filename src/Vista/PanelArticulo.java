...
import java.awt.event.ItemEvent; // Necesario para el ItemListener si no está importado
...
public class PanelArticulo extends javax.swing.JFrame {

    private final ArticuloControlador controlador;
    private DefaultTableModel modeloTabla;
    private Usuario usuarioActual; 

    public PanelArticulo(Usuario usuario) {
        initComponents();
        
        // ====================================================================
        // === NUEVA LÓGICA DE VISIBILIDAD INICIAL Y LISTENER ===
        // ====================================================================

        // 1. Establecer la visibilidad inicial: Ocultar los campos de Bien Nacional.
        if (jLabelBienNacional != null) jLabelBienNacional.setVisible(false);
        if (jFTextCodigoBienNacional != null) jFTextCodigoBienNacional.setVisible(false);
        
        // 2. Configurar el listener para la casilla
        if (jCheckBoxBienNacional != null) {
            jCheckBoxBienNacional.addItemListener(e -> {
                boolean isChecked = e.getStateChange() == ItemEvent.SELECTED;
                
                // Mostrar/Ocultar los componentes
                jLabelBienNacional.setVisible(isChecked);
                jFTextCodigoBienNacional.setVisible(isChecked);
                
                // Limpiar el campo si se desmarca (buena práctica UX)
                if (!isChecked) {
        ...
        // ⭐ APLICACIÓN SEGURA DEL FILTRO NUMÉRICO (Código Bien Nacional) ⭐
        if (jFTextCodigoBienNacional != null) {
        ...
        // ⭐ APLICACIÓN DEL FILTRO DE LETRAS (Nombre) ⭐
        if (jFTextNombre != null) {
    ...
    // El resto de los métodos y la implementación de filtros (SoloNumerosLongitudFijaFilter y SoloLetrasYEspaciosFilter) deben existir en el archivo original.
    ...
    private void initComponents() {
        ...
        jLabelBienNacional = new javax.swing.JLabel();
        ...
        jCheckBoxBienNacional = new javax.swing.JCheckBox();
        ...
        jLabel1.setText("Gestión de Bienes Nacionales y Artículos");
        ...
        jPanel7.add(jFTextCodigoBienNacional, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 200, 130, 30));

        jLabel13.setText("Categoría");
        jPanel7.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 240, 160, 30));

        jLabelBienNacional.setText("Código De Bien Nacional:");
        jPanel7.add(jLabelBienNacional, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 200, 150, 30));
        ...
        jPanel7.add(jFTextDetalles, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 120, 130, 30));

        jLabel20.setText("Detalles:");
        jPanel7.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, 170, 30));
        ...
        jCheckBoxBienNacional.setText("Marcar si es un Bien Nacional");
        jPanel7.add(jCheckBoxBienNacional, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 180, 300, -1));
    ...
    private void bCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCrearActionPerformed
     try {
        ...
        // ⭐ NUEVO: Validar longitud exacta del Código Bien Nacional ⭐
        if (codigo.length() != 8) {
            JOptionPane.showMessageDialog(this,
                "El Código Bien Nacional debe tener exactamente 8 dígitos.",
                "Validación",
    ...
    private void bExportarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bExportarActionPerformed
        ...
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                // 1. Crear el escritor PDF y abrir el documento
                ...
                // 3. Preparar la tabla PDF
                // El número de columnas debe coincidir con la tabla visible (7 en total, 6 visibles)
                // Usamos 6 columnas visibles, excluyendo el ID (columna 0)
                ...
                BaseColor headerColor = new BaseColor(52, 152, 219); // Azul bonito
                
                for (int i = 1; i < colCount; i++) { // Empezamos en 1 para ignorar la columna ID (0)
                ...
                JOptionPane.showMessageDialog(this, 
                        "El reporte se ha exportado exitosamente a:\n" + fileToSave.getAbsolutePath(), 
                        "Exportación Exitosa", 
                        JOptionPane.INFORMATION_MESSAGE);

            } catch (DocumentException | FileNotFoundException ex) {
                Logger.getLogger(PanelArticulo.class.getName()).log(Level.SEVERE, null, ex);
                JOptionPane.showMessageDialog(this, 
    ...
    private static class SoloNumerosLongitudFijaFilter extends DocumentFilter {
        ...
        public SoloNumerosLongitudFijaFilter(int maxLength) {
            this.maxLength = maxLength;
        }

        private String keepDigits(String text) {
            if (text == null) return "";
        ...
        public void replace(FilterBypass fb, int offset, int length, String text, AttributeSet attrs)
            ...
            if (filtered.isEmpty()) {
                if (length > 0) super.replace(fb, offset, length, "", attrs);
                return;
            }
    ...
    /**
     * Evita que se introduzcan dígitos en el campo (permite letras, espacios y otros símbolos).
     */
...
private void cargarFormularioDesdeTabla(int fila) {
    ...
    private javax.swing.JCheckBox jCheckBoxBienNacional;
    ...
    private javax.swing.JLabel jLabelBienNacional;
